...
class GiftTagServiceTest {
    ...
    private static final TagResponseDto ADDED_RESPONSE = new TagResponseDto(3, "added");
    ...
    private static final List<GiftTag> ALL_TAGS = Arrays.asList(FIRST_TAG, SECOND_TAG);
